...
public class SimpleRefalBlockImpl extends ASTWrapperPsiElement implements SimpleRefalBlock {

  public SimpleRefalBlockImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SimpleRefalSentence> getSentenceList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SimpleRefalSentence.class);
  }
