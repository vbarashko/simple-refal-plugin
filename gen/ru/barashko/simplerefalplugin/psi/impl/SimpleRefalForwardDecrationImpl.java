...
public class SimpleRefalForwardDecrationImpl extends ASTWrapperPsiElement implements SimpleRefalForwardDecration {

  public SimpleRefalForwardDecrationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SimpleRefalVisitor visitor) {
    visitor.visitForwardDecration(this);
  }
