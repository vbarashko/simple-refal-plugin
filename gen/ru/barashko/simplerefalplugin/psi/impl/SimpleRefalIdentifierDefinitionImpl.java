...
public class SimpleRefalIdentifierDefinitionImpl extends ASTWrapperPsiElement implements SimpleRefalIdentifierDefinition {

  public SimpleRefalIdentifierDefinitionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SimpleRefalVisitor visitor) {
    visitor.visitIdentifierDefinition(this);
  }
