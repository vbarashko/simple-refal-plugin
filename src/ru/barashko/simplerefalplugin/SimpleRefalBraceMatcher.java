...
public class SimpleRefalBraceMatcher implements PairedBraceMatcher {
    private static final BracePair[] PAIRS = new BracePair[] {
            ...
            new BracePair(SimpleRefalTypes.LBRACKET, SimpleRefalTypes.RBRACKET, false),
            new BracePair(SimpleRefalTypes.LCHEVRON, SimpleRefalTypes.RCHEVRON, false),
            new BracePair(SimpleRefalTypes.LPAREN, SimpleRefalTypes.RPAREN, false)
